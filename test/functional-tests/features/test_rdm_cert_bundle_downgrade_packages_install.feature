...
Feature: Package installation verification
  ...
  Scenario: Ensure packages are successfully installed for cert version downgrade
    ...
    And running "ls -lh /media/apps/rdm/downloads/cert-test-bundle" should list the package files with expected sizes
