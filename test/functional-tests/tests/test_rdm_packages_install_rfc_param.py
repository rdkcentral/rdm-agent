...
def test_RFC_Set_Get_Handler():
    ...
    command_to_check = "tr181 -d -s -t string -v https://mockxconf:50056/rdmUploadFile Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.CDLDM.CDLModuleUrl"
...
def test_tr181_value():
    command_to_check = "tr181 -d -g Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.CDLDM.CDLModuleUrl"
    result = run_shell_command(command_to_check)
    assert "https://mockxconf:50056/rdmUploadFile" in result, '"https://mockxconf:50056/rdmUploadFile" not found in the output'
...
def test_tr181_param():
    RDM_URL_MSG = "RDM URL: https://mockxconf:50056/rdmUploadFile"
    assert RDM_URL_MSG in grep_RDMlogs(RDM_URL_MSG)
