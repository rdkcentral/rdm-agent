...
def test_rdm_cert_download_status():
    ...
    DL_STATUS_MSG = "RDM package download success: cert-test-bundle_0.7-signed.tar"
...
def test_expected_files_present():
    path = "/media/apps/rdm/downloads/cert-test-bundle"
    expected_files = ["pkg_cpemanifest", "package.json", "pkg_padding", "cert-test-bundle_0.7.tar", "cert-test-bundle_0.7.sig"]
