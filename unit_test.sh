...
if [ "$ENABLE_COV" = true ]; then
    ...
    lcov --extract raw_coverage.info '/__w/rdm-agent/rdm-agent/src/*.c'  '/__w/rdm-agent/rdm-agent/unittest/*.cpp' '/__w/rdmagent/rdmagent/rdm_main.c' --output-file rdm_coverage.info
